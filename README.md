# 🌐 ESP32 OV2640 Camera Web Server

**Author:** Pipisara Chandrabhanu

This project creates a **web server** on the ESP32, using the **OV2640** camera module, to deliver live video streaming and remote camera control. 🌟
